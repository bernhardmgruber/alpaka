...
public:
    ...
    ALPAKA_FN_ACC auto operator()(
        TAcc const& acc,
        alpaka::Accessor<TMemoryHandleA, TElem, TIdx, 1, alpaka::ReadAccess> const A,
        alpaka::Accessor<TMemoryHandleB, TElem, TIdx, 1, alpaka::ReadAccess> const B,
        alpaka::Accessor<TMemoryHandleC, TElem, TIdx, 1, alpaka::WriteAccess> const C) const -> void
    {
