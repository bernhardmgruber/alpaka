...
public:
    ...
    ALPAKA_FN_ACC auto operator()(
        ...
        TIndex const& k,
        TElem const& alpha,
        alpaka::Accessor<TMemoryHandleA, TElem, TIndex, 2, alpaka::ReadAccess> const A,
        alpaka::Accessor<TMemoryHandleB, TElem, TIndex, 2, alpaka::ReadAccess> const B,
        TElem const& beta,
        alpaka::Accessor<TMemoryHandleC, TElem, TIndex, 2, alpaka::ReadWriteAccess> const C) const -> void
    {
        static_assert(
    ...
    namespace traits
    {
        ...
        struct BlockSharedMemDynSizeBytes<MatMulKernel, TAcc>
        {
            ...
            ALPAKA_FN_HOST_ACC static auto getBlockSharedMemDynSizeBytes(
                ...
                alpaka::Accessor<TMemoryHandleB, TElem, TIndex, 2, alpaka::ReadAccess> const B,
                TElem const& beta,
                alpaka::Accessor<TMemoryHandleC, TElem, TIndex, 2, alpaka::ReadWriteAccess> const C)
            {
