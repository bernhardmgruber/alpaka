...
public:
    ...
    ALPAKA_FN_ACC auto operator()(
        TAcc const& acc,
        TElem const& alpha,
        alpaka::Accessor<TMemoryHandleX, TElem, TIdx, 1, alpaka::ReadAccess> const X,
        alpaka::Accessor<TMemoryHandleY, TElem, TIdx, 1, alpaka::ReadWriteAccess> const Y) const -> void
    {
